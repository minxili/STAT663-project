...
.pollutant-card {
  ...
  border-radius: 8px;
  padding: 8px 10px;   /* ⬅ 比之前小很多 */
  text-align: left;
  font-size: 0.70em;   /* ⬅ 再缩小字号 */
  line-height: 1.25;
}
.pollutant-title {
  background: #1E88E5;
...
<div class="pollutant-card">
  <div class="pollutant-title">Ozone (O₃)</div>
  <ul>
    <li><em>Not directly emitted</em> (secondary pollutant)</li>
    <li>Formed via <strong>sunlight + NOx + VOCs</strong></li>
    <li>Strongly tied to temperature & weather</li>
  </ul>
</div>

<div class="pollutant-card">
  <div class="pollutant-title">Carbon Monoxide (CO)</div>
  <ul>
    <li>Incomplete combustion</li>
    <li>Vehicles, trucks, heating, wildfires</li>
    <li>Declines with cleaner engines & fuel rules</li>
  </ul>
</div>

<div class="pollutant-card">
  <div class="pollutant-title">Nitrogen Dioxide (NO₂)</div>
  <ul>
    <li>Traffic emissions & industrial combustion</li>
    <li>Highest in dense urban areas</li>
    <li>Steady decline with emission standards</li>
  </ul>
</div>

<div class="pollutant-card">
  <div class="pollutant-title">Sulfur Dioxide (SO₂)</div>
  <ul>
    <li>Coal-burning power plants, metal smelting</li>
    <li>Sharpest decline among the four</li>
    <li>Driven by coal phase-out & scrubbers</li>
  </ul>
</div>
