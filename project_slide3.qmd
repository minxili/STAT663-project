---
title: "Visualizing Two Decades of U.S. Air Pollution (2000–2022)"
...
::: smaller
-   Data come from the **U.S. Pollution Dataset (2000–2023)** available on Kaggle.
...
-   **Main Research Question**:
    ...
    -   How has U.S. air quality changed from 2000 to 2022 across time, regions, and pollutants?
...
# Section A. Long-Term Trend Analysis (2000–2022)
...
heat_no2 <- ggplot(monthly_no2, aes(x = month, y = year, fill = no2)) +
  ...
  scale_fill_viridis_c(option = "C") +
  labs(
    title = "Seasonal Heatmap of NO2 AQI (2000–2022)",
    x = "Month",
    y = "Year",
    fill = "NO2 AQI"
  ) +
...
heat_co <- ggplot(monthly_co, aes(x = month, y = year, fill = co)) +
  ...
  scale_fill_viridis_c(option = "C") +
  labs(
    title = "Seasonal Heatmap of CO AQI (2000–2022)",
    x = "Month",
    y = "Year",
    fill = "CO AQI"
  ) +
...
heat_so2 <- ggplot(monthly_so2, aes(x = month, y = year, fill = so2)) +
  ...
  scale_fill_viridis_c(option = "C") +
  labs(
    title = "Seasonal Heatmap of SO2 AQI (2000–2022)",
    x = "Month",
    y = "Year",
    fill = "SO2 AQI"
  ) +
...
# State-Level Pollution Patterns (2010–2022)
...
-   Some states show gradual improvement, but the overall national pattern is relatively stable compared with other pollutants.
-   Occasionally exhibit very high ozone years, linked to extreme heat or wildfire smoke.
:::

# Regional Pollution Comparison (2010–2022)
