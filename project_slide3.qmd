...
- Data come from the **U.S. Pollution Dataset (2000–2022)** available on Kaggle:
  https://www.kaggle.com/datasets/guslovesmath/us-pollution-data-2000-to-2022

- This dataset is compiled from the **U.S. EPA Air Quality System (AQS)**, which provides 
  daily measurements of major air pollutants from monitoring stations across the United States.

- For this project, the daily measurements are aggregated into **state-level annual averages** 
  from 2000 to 2023.
...
- Time-Series Decomposition
  - STL decomposition for O₃ to separate trend, seasonal, and remainder components
:::
...
::: smaller
Most pollutants (NO₂, SO₂, CO) show clear long-term declines, while O₃ remains stable with strong, recurring summer peaks.
::: 
...
-   PCA summarizes two things:

    -   Overall pollution burden (PC1)
    
    -   Pollution composition (ozone-dominated vs combustion-dominated)
